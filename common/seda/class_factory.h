 ...
 */
template <class T> ClassFactory<T>*& ClassFactory<T>::fact_list_head() {
...
// Destructor
template <class T> ClassFactory<T>::~ClassFactory() {}
 ...
 * create an instance.
 */
template <class T> T* ClassFactory<T>::make_instance(const std::string& tag) {
    T*               instance = NULL;
