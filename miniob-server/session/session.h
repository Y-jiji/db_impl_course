...
class Session {
    ...
    void               set_transaction_multi_operation_mode(bool multi_operation_mode);
    bool               is_transaction_multi_operation_mode() const;
    ...
    bool        transaction_multi_operation_mode_ =
