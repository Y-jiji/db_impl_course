...
RC TableMeta::init_sys_fields() {
    ...
    RC rc = field_meta.init(Transaction::transaction_field_name(), Transaction::transaction_field_type(), 0,
...
const FieldMeta* TableMeta::transaction_field() const { return &fields_[0]; }
