...
#ifndef __OBSERVER_STORAGE_transaction_transaction_H_
#define __OBSERVER_STORAGE_transaction_transaction_H_
...
class Transaction {
    public:
    static int32_t     default_transaction_id();
    static int32_t     next_transaction_id();
    static const char* transaction_field_name();
    static AttrType    transaction_field_type();
    static int         transaction_field_len();
    ...
    void init_transaction_info(Table* table, Record& record);

    private:
    void        set_record_transaction_id(Table* table, Record& record,
                                          int32_t transaction_id, bool deleted) const;
    static void get_record_transaction_id(Table* table, const Record& record,
...
#endif // __OBSERVER_STORAGE_transaction_transaction_H_
