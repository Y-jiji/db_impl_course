...
RC DefaultHandler::create_index(Transaction* transaction, const char* dbname,
...
RC DefaultHandler::drop_index(Transaction* transaction, const char* dbname,
                              const char* relation_name,
                              const char* index_name) {
...
RC DefaultHandler::insert_record(Transaction* transaction, const char* dbname,
...
RC DefaultHandler::delete_record(Transaction* transaction, const char* dbname,
...
RC DefaultHandler::update_record(Transaction* transaction, const char* dbname,
                                 const char* relation_name,
